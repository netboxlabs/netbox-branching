...
* [#617](https://github.com/netboxlabs/netbox-branching/issues/617) - Advance the migration state for migrations faked on a branch, so that later data migrations see the current historical models
